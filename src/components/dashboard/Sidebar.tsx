...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-full h-full bg-[#101828] overflow-y-auto">
      <div className="py-6 md:py-10 flex flex-col h-full">
        <div className="px-4 mb-6">
          <img
            ...
            alt="Logo"
            className="aspect-[6.49] object-contain w-[80%] mx-auto md:mx-0"
          />
        </div>
